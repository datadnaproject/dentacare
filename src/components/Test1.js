const handleDeleteAppointment = (date, patientName) => {
  ...
  // Query appointments with the specified date and patient name
  appointmentsRef
    ...
    .once("value", (snapshot) => {
      snapshot.forEach((childSnapshot) => {
        ...
        // Check if the appointment matches the specified patient name
        if (appointment.Appointmenttab_name === patientName) {
